...
void addAirports() {
  ...
  myAirports.add(new Airport(, , "CHO", ON_TOP));
  myAirports.add(new Airport(, , "BTV", ON_TOP));
  myAirports.add(new Airport(, , "FNT", ON_TOP));
  myAirports.add(new Airport(, , "VPS", ON_TOP));
  myAirports.add(new Airport(, , "LFT", ON_TOP));
  myAirports.add(new Airport(, , "AVL", ON_TOP));
  myAirports.add(new Airport(, , "ATW", ON_TOP));
  myAirports.add(new Airport(, , "BPT", ON_TOP));
  myAirports.add(new Airport(, , "LAN", ON_TOP));
  myAirports.add(new Airport(, , "MYR", ON_TOP));
  myAirports.add(new Airport(, , "ABE", ON_TOP));
  myAirports.add(new Airport(, , "CLL", ON_TOP));
  myAirports.add(new Airport(, , "RST", ON_TOP));
  myAirports.add(new Airport(, , "GRI", ON_TOP));
  myAirports.add(new Airport(, , "MRY", ON_TOP));
  myAirports.add(new Airport(, , "SPI", ON_TOP));
  myAirports.add(new Airport(, , "MOB", ON_TOP));
  myAirports.add(new Airport(, , "MGM", ON_TOP));
  myAirports.add(new Airport(, , "TLH", ON_TOP));
  myAirports.add(new Airport(, , "SDF", ON_TOP));
  myAirports.add(new Airport(, , "MLU", ON_TOP));
  myAirports.add(new Airport(, , "MAF", ON_TOP));
  myAirports.add(new Airport(, , "TXK", ON_TOP));
