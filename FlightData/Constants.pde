...
final int START = 1;
final int CHANGED= 2; 
final int CHART_BUTTON_SIZE = 350;
final int DEP_X = 580;
final int DEP_Y = 37;
final int ARR_X = DEP_X;
final int ARR_Y = DEP_Y + CHART_BUTTON_SIZE + 135;
final int PIE_X = 1050;
final int PIE_Y = 167;
final int PIE_2_X = PIE_X;
final int PIE_2_Y = 170 + CHART_BUTTON_SIZE;
...
final int PIE_CHART_SCREEN_ARR_DEP = 15;
final int PIE_CHART_SCREEN_CANC_DIV = 16;
final int INCOMING_BAR_CHART_SCREEN = 17;
final int SEARCH_SCREEN = 18;
//filters
...
final int PIE_CHART_EVENT_ARR_DEP = 21;
final int PIE_CHART_EVENT_CANC_DIV = 22;
final int SELECT_SEARCH_EVENT = 23;
final int CHART_SELECTION_EVENT = 24; //has to be last
//regions
